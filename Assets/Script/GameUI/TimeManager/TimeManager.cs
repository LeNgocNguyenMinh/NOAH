...
public class TimeManager : MonoBehaviour
{
    ...
    private GameObject lightSource = null;//Create the list of the light such as light from house
    private ParticleSystem fireFly;
    private bool startNightMode = false;
    private Light2D sunLight; //List of Sunlight 
    ...
    private void Start()
    {
        lightSource = LightSourceManager.Instance.objectLightSource;
        sunLight = LightSourceManager.Instance.globalLightSource;
        fireFly = ParticalManager.Instance.fireFly;
    }
    ...
    public void CalcTime() // Used to calculate sec, min and hours
    {
        ...
        sunLight.color = sunLightGradient.Evaluate(percentage);
