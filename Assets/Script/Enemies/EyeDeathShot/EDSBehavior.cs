...
public class EDSBehavior : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        Move();
        RaycastHit2D hitInfo = Physics2D.Raycast(transform.position, transform.right, 30f);
        ...
        {
            Debug.Log("Chua ve");
            Debug.DrawLine(transform.position, transform.position + transform.right*30f, Color.green);
        }
